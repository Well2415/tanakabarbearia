...
-- ÍNDICE ÚNICO PARA EVITAR NÚMEROS DA SORTE DUPLICADOS NO SUPABASE
CREATE UNIQUE INDEX IF NOT EXISTS idx_unique_appointments_raffle_number 
ON appointments ("raffleNumber") 
WHERE "raffleNumber" IS NOT NULL AND "raffleNumber" <> '';
